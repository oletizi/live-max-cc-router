...
A TypeScript-based CC router for Launch Control XL3 that compiles to JavaScript for Max for Live. This gives you the benefits of TypeScript development (types, IntelliSense, refactoring) while producing Max-compatible JavaScript.
